...
export const toastVariants = {
  primary: {
    title: 'bg-blue-100 text-black',
    body: 'bg-blue-500 text-white',
  },
  secondary: {
    title: 'bg-gray-100 text-black',
    body: 'bg-gray-500 text-white',
  },
  success: {
    title: 'bg-green-100 text-black',
    body: 'bg-green-500 text-white',
  },
  danger: {
    title: 'bg-red-100 text-black',
    body: 'bg-red-500 text-white',
  },
  warning: {
    title: 'bg-yellow-100 text-black',
    body: 'bg-yellow-500 text-white',
  },
  info: {
    title: 'bg-sky-100 text-black',
    body: 'bg-sky-500 text-white',
  },
  upsell: {
    title: 'bg-purple-100 text-black',
