...
import type CompsListFilterController from '../../controllers/comps/list-filter';

export default RouteTemplate<{
  Args: {
    controller: CompsListFilterController;
  };
}>(
  <template>
    {{pageTitle "List filter"}}
    {{breadcrumb "List filter" route="comps.list-filter"}}
