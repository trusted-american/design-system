...
import type CompsFormFileDropzoneController from '../../../controllers/comps/form/file-dropzone';

export default RouteTemplate<{
  Args: {
    controller: CompsFormFileDropzoneController;
  };
}>(
  <template>
    {{pageTitle "Form file dropzone"}}
    {{breadcrumb "Form file dropzone" route="comps.form.file-dropzone"}}
