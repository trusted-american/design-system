...
import type CompsFormRadioCardController from '../../../controllers/comps/form/radio-card';

export default RouteTemplate<{
  Args: {
    controller: CompsFormRadioCardController;
  };
}>(
  <template>
    {{pageTitle "Form radio card"}}
    {{breadcrumb "Form radio card" route="comps.form.radio-card"}}
